...
export default function Hero(){
    ...
    return <section className="min-h-screen pt-32 pb-20 px-6 flex items-center justify-center relative overflow-hidden text-white">
        ...
        <div className='flex flex-col items-center'>
            ...
            <p className="text-lg md:text-xl text-gray-500 max-w-2xl mx-auto text-balance leading-relaxed">
                Experience the next generation of AI search.Get instant, accurate answers with deep insights powered by cutting-edge artificial intelligence.
            </p>
